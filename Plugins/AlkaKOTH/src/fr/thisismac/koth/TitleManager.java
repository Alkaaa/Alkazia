...
public class TitleManager {
	...
	/*
	 * Temps oů l'affichage des titles apparait, reste et part par défaut, ŕ modifier directement si besoin Attention
	...
	public static void sendTitle(Player player, String title, String subTitle, int fadeIn, int fadeOut, int time) {
		...
		// times a un argument de "titre" il est ignoré... et seul les param du temps reste, super GG, quel intéręt
	...
	/**
	 * Envoyer ŕ plusieurs joueurs (configurable)
	 * @param players
	 * @param title
	 * @param subTitle
	 * @param fadeIn
	...
	/**
	 * Envoyer un title ŕ tous les joueurs (configurable)
	 * @param players
	 * @param title
	 * @param subTitle
	 * @param fadeIn
	...
	/**
	 * Envoyer un title ŕ tous les joueurs
	 * @param title
	 * @param subTitle
	 */
